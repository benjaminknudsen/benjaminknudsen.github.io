...
import bluntTextScaleImage from "../assets/images/blunttekststørrelser.svg";
    ...
    <article className="lynk-case blunt-case" ref={caseRef}>
      ...
      <section className="lynk-section lynk-container blunt-introduction">
        <div className="blunt-reveal">
          <p className="lynk-kicker">01 — Kort om projektet</p>
      ...
      <section className="lynk-section lynk-container blunt-brand">
        <header className="blunt-section-heading blunt-reveal">
          <p className="lynk-kicker">02 — Brandunivers</p>
          <h2>Et brand, der tør fylde.</h2>
        </header>
      ...
      <section className="lynk-section blunt-social-section">
        <div className="lynk-container">
          <header className="blunt-social-heading blunt-reveal">
            <div>
              <p className="lynk-kicker">03 — So Me</p>
              <h2>Skabt til at stoppe scrollen.</h2>
            </div>
      ...
      <section className="lynk-section blunt-dark-section">
        <div className="lynk-container blunt-audience">
          <div className="blunt-reveal">
            <p className="lynk-kicker">04 — Målgruppe og idé</p>
            <h2>Designet til den impulsive shopper.</h2>
            <p>Universet henvender sig til 15–25-årige, som følger trends og bruger mode til at vise identitet. Derfor blev tydelige produkter, urgency og en stærk brandfølelse centrale dele af oplevelsen.</p>
            <ul className="blunt-audience-tags" aria-label="Centrale fokusområder">
              <li>15–25 år</li><li>Trends</li><li>Urgency</li><li>Identitet</li>
            </ul>
          </div>
      ...
      <section className="lynk-section blunt-ux-shop-section">
        <div className="lynk-container">
          <header className="blunt-section-heading blunt-reveal">
            <p className="lynk-kicker">05 — Det færdige produkt</p>
            <h2>Fra brand til webshop.</h2>
            <p>Den færdige løsning samler brand, navigation og købsoplevelse i ét konsekvent visuelt univers.</p>
          </header>
      ...
      <section className="lynk-section blunt-system-section">
        <div className="lynk-container">
          <header className="blunt-section-heading blunt-reveal">
            <p className="lynk-kicker">06 — Designsystem</p>
            <h2>Et system med kant.</h2>
          </header>
      ...
      <section className="lynk-section lynk-reflection blunt-reflection">
        <div className="lynk-container blunt-reveal">
          <p className="lynk-kicker">07 — Refleksion</p>
